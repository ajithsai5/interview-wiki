...
# Labels match the seeded sample notes so your pages merge under the same
# sidebar headings instead of creating near-duplicate domains.
DOMAIN_BY_FOLDER = {
...
def main():
    ...
    # Merge with any notes already loaded (the seeded sample notes in
    # app/content/*.js). Your notes override a sample only when ids match.
    js = (
